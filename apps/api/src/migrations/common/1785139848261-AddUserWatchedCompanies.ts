...
export class AddUserWatchedCompanies1785139848261 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_watched_companies_company" DROP CONSTRAINT "FK_8ac281b1570c09222d17d15e158"`);
        await queryRunner.query(`ALTER TABLE "user_watched_companies_company" DROP CONSTRAINT "FK_4e21cc3f76892a998bf597e8266"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8ac281b1570c09222d17d15e15"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4e21cc3f76892a998bf597e826"`);
